        ...
        <div class="chatbot-shell">
            ...
            <aside class="chatbot-info">
                ...
                <div class="chatbot-note">
                    <strong>🌟 Importante:</strong> Este asistente complementa tu proceso de bienestar emocional pero no
                    reemplaza la atención profesional. Si estás en crisis, sientes que podrías hacerte daño o necesitas
                    ayuda inmediata, por favor contacta a una persona de confianza o llama a la línea de emergencia de tu
                    país.
                    <div
                        style="margin-top: 12px; padding: 8px; background: rgba(255,255,255,0.5); border-radius: 12px; text-align: center;">
                ...
                <div style="margin-top: 10px; padding: 12px; background: rgba(77,184,168,0.05); border-radius: 16px;">
                    <p style="color: var(--text-soft); font-size: 0.85rem; margin-bottom: 8px;">
                        ...
                        Recuerda que puedes hablar de lo que necesites: ansiedad, estrés, tristeza, dificultades para
                        dormir, o simplemente cómo fue tu día.
                    </p>
                </div>
            </aside>
                ...
                <div id="chat-box" class="chatbot-messages">
                    @if (isset($messages) && $messages->count())
                        @foreach ($messages as $msg)
                            <div class="chatbot-message-row {{ $msg->sender === 'user' ? 'user' : 'bot' }}">
                                <div class="chatbot-message {{ $msg->sender === 'user' ? 'user' : 'bot' }}">
                                    @if ($msg->sender === 'bot')
                                    ...
                                    <div class="chatbot-meta">
                                        <span>{{ $msg->sender === 'user' ? 'Tú' : 'Asistente' }}</span>
                ...
                <div class="chatbot-form-wrap">
                    <form id="chat-form" class="chatbot-form">
                        ...
                        <div class="chatbot-input-wrapper">
                            <input type="text" id="message" name="message" class="chatbot-input"
                                placeholder="Escribe tu mensaje..." maxlength="500" autocomplete="off" required>
